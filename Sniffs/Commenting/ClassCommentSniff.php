...
if (class_exists('Symfony2_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class Symfony2_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Symfony2_Sniffs_Commenting_ClassCommentSniff extends Symfony2_Sniffs_Commenting_FileCommentSniff
{
